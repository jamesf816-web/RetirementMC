...
class AccountsIncomeEngine:
    ...
    def compute_ss_benefit(self, current_year: int, inflation_index: float) -> float:
        ...
        # 3. Apply Inflation
        total_ss_benefit *= inflation_index
        ...
        if current_year >= self.inputs.ss_fail_year:
            ...
            total_ss_benefit *= (1 - self.inputs.ss_fail_percent)

        return total_ss_benefit

    # ----------------------------------------------------------------------
    # RMDs
    # ----------------------------------------------------------------------
    def compute_rmds(self, current_year: int, accounts_bal: dict) -> tuple[float, dict]:
        """
    ...
    # Trust Income 
    # ----------------------------------------------------------------------
    def compute_trust_income(self, current_year: int, inflation_index: float, accounts: dict) -> float:
        """
    ...
    # Def 457b 
    # ----------------------------------------------------------------------
    def compute_def457b_income(self, current_year: int, inflation_index: float, accounts: dict) -> float:
        """
    ...
    # Pension
    # ----------------------------------------------------------------------
    def compute_pension_income(self, current_year: int, inflation_index: float) -> float:
        amount1 = 0.0
        amount2 = 0.0
    ...
    # Salary
    # ----------------------------------------------------------------------
    def compute_salary_income(self, current_year: int, inflation_index: float) -> float:
        amount1 = 0.0
        amount2 = 0.0
